...
window.onload = function () {
  ...
  document.getElementById('Submit').addEventListener('click', function () {
    ...
    showTable(ProductLogicObj, ProductLogicObj.Products);
    document.getElementById('functionality').innerHTML = "<input type='text' id='searchPro' placeholder='Search Product Name'> <input type='submit' value='Search' id='btnSearchPro'>  <input type='text' id='searchBy' placeholder='Group By Value'> <input type='submit' value='Search' id='btnSearchCat'>  <input type='text' id='deleteBy' placeholder='Delete by Product-Id'> <input type='submit' value='Delete' id='btnDelete'> <input type='text' id='updateBy' placeholder='Update by Product-Id'> <input type='submit' value='Update' id='btnUpdate'>";
    ...
    document.getElementById('btnUpdate').addEventListener('click', function () {
      ...
      ProductLogicObj.Products.forEach(function (obj) {
        if (obj['ProductId'] == updateIdVal) {
          ...
          document.getElementById('dvButton').innerHTML = document.getElementById('dvButton').innerHTML + "<input type='submit' id='updateBtn' value='Done'>";
