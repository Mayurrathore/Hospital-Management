    ...
    return (
      ...
      <div  style={{width:1089} } >
        ...
        <h3 align='center'>Register NewNurse </h3> 
               ...
               <label for="choose" style={{fontFamily:"-moz-initial" ,fontSize:20}} class="col-sm-2 col-form-label"> Nurse Id</label>
               <input 
               ...
               <div className='form-group row'>
               <label for="choose" class="col-sm-2 col-form-label" style={{fontFamily:"-moz-initial" ,fontSize:20}}>Nurse Name</label>
               ...
               <div className='form-group row'>
               <label for="choose" class="col-sm-2 col-form-label" style={{fontFamily:"-moz-initial" ,fontSize:20}}>Nurse Address</label>
               <input type='text' 
               class="col-sm-9" 
               ...
               <div className='form-group row'>
               <label for="choose" class="col-sm-2 col-form-label" style={{fontFamily:"-moz-initial" ,fontSize:20}}>Nurse_City</label>
               <input type='text'
                class="col-sm-9"
               ...
               <div className='form-group row'>
               <label for="choose" class="col-sm-2 col-form-label" style={{fontFamily:"-moz-initial" ,fontSize:20}}>Nurse Email</label>
               <input type='text'
                class="col-sm-9"
               ...
               <div className='form-group row'>
               <label for="choose" class="col-sm-2 col-form-label" style={{fontFamily:"-moz-initial" ,fontSize:20}}>Nurse wardinfo</label>
               <input type='text'
                class="col-sm-9"
